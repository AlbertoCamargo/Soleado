...
class LoadsControllerTest < ActionController::TestCase
  ...
  test "should create load" do
    assert_difference('Load.count') do
      post :create, load: { daily_hours: @load.daily_hours, name: @load.name, owner_id: @load.owner_id, rated_power: @load.rated_power, type: @load.type }
    end
  ...
  test "should update load" do
    patch :update, id: @load, load: { daily_hours: @load.daily_hours, name: @load.name, owner_id: @load.owner_id, rated_power: @load.rated_power, type: @load.type }
    assert_redirected_to load_path(assigns(:load))
  end
